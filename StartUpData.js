 export const StatUp_Ideas = [
    {
      "category": "Technologie",
      "title": "Chatbot en langue arabe",
      "description": "Assistant virtuel intelligent pour les entreprises locales, intégrant le dialecte algérien.",
      "details": "Une startup développant un chatbot en langue arabe et tamazight pourrait révolutionner le service client en Algérie en automatisant les interactions avec les entreprises. Basé sur l’IA et le traitement du langage naturel (NLP), ce chatbot comprendrait le darija et l’arabe classique, offrant des réponses précises sur WhatsApp, Messenger ou les sites web, réduisant le temps d’attente et améliorant l’expérience utilisateur. Le modèle économique reposerait sur un abonnement SaaS pour les entreprises, avec des options de personnalisation et d’intégration API.",
      "keywords": ["IA", "chatbot", "arabe", "tamazight", "entreprise"],
      "emoji": "🚀"
    },
    {
      "category": "Technologie",
      "title": "Aménagement intérieur en AR",
      "description": "Application permettant aux clients de visualiser les meubles et décorations avant achat.",
      "details": "Cette startup propose une application de réalité augmentée (AR) permettant aux utilisateurs en Algérie de visualiser et personnaliser leur aménagement intérieur avant l’achat. Avec leur smartphone, ils peuvent tester des meubles, peintures et luminaires directement dans leur espace via la caméra, facilitant ainsi leurs décisions d’achat. Cette solution s’adresse aux magasins de meubles, décorateurs et enseignes de bricolage, leur offrant une vitrine numérique interactive pour booster leurs ventes. Le modèle économique repose sur des abonnements B2B pour les entreprises et des fonctionnalités premium pour les particuliers.",
      "keywords": ["réalité augmentée", "meubles", "application mobile", "B2B", "design"],
      "emoji": "🏠"
    },
    {
      "category": "Technologie",
      "title": "Automatisation des entrepôts",
      "description": "Robots intelligents pour gérer les stocks et optimiser la logistique.",
      "details": "Cette startup développe des robots intelligents pour automatiser la gestion des entrepôts, optimisant ainsi le stockage et la logistique des entreprises en Algérie. Équipés d’IA et de capteurs, ces robots peuvent déplacer, trier et inventorier les marchandises de manière autonome, réduisant les erreurs humaines et accélérant le traitement des commandes. Idéal pour les grossistes, e-commerçants et entreprises industrielles, ce système permet d’améliorer l’efficacité, réduire les coûts et maximiser l’espace de stockage. Le modèle économique repose sur la vente ou la location des robots, accompagnée d’un logiciel de gestion cloud.",
      "keywords": ["logistique", "robotique", "IA", "automatisation", "entrepôts"],
      "emoji": "🚛"
    },
    {
      ...
      },
      {
        ...
        "title": "Unités mobiles de recyclage",
        "description": "Déploiement d'unités de recyclage compactes et mobiles dans les quartiers ou les zones rurales pour faciliter le tri et le traitement des déchets.",
        "details": "Des unités de recyclage mobiles seraient déployées dans les quartiers et les zones rurales d'Algérie pour trier et traiter les déchets (plastique, papier, métaux). Ce projet nécessiterait des unités adaptées, des autorisations, des campagnes de sensibilisation au tri et des partenariats pour valoriser les matériaux recyclés, rapprochant ainsi le recyclage des habitants, réduisant les coûts de transport et améliorant les taux de recyclage locaux.",
        "keywords": ["recyclage", "déchets", "environnement", "mobilité", "zones rurales"],
        "emoji": ""
      },
      {
        "category": "Environnement",
  ...
  export const StartUp_Examples = [
    ...
    },
    {
      "category": "Technologie",
      "title": "Volz",
      "description": "Plateforme de réservation de billets d’avion en ligne en partenariat avec plus de 21 compagnies aériennes.",
      "details": "Créée en 2022, Volz est une startup algérienne qui facilite la réservation de vols en ligne, avec des options locales et internationales. Elle a participé à la conférence des startups africaines en 2024.",
      "founders": [],
      "founded": "2022",
      "keywords": ["billetterie", "voyage", "réservation", "transport aérien", "e-commerce"],
      "emoji": "🛫"
    },
    {
      "category": "Technologie",
      "title": "Opticharge",
      "description": "Plateforme B2B d'optimisation du transport routier de marchandises.",
      "details": "Opticharge, lancée officiellement en février 2020, connecte en temps réel les expéditeurs et les transporteurs pour améliorer la logistique, optimiser les trajets et réduire les coûts du transport routier.",
      "founders": [],
      "founded": "2019",
      "keywords": ["logistique", "transport", "B2B", "expédition", "optimisation"],
      "emoji": "🚚"
    },
    {
      "category": "Technologie",
      "title": "AITech",
      "description": "Startup agricole intégrant l'IA et l'IoT pour l'agriculture et la gestion de l'eau.",
      "details": "Créée en 2016 par Mabrouk Aib et Nassim Ilmane, AITech développe des solutions innovantes pour optimiser les pratiques agricoles et améliorer la gestion des ressources hydriques à l'aide de l'intelligence artificielle et de l'Internet des objets.",
      "founders": ["Mabrouk Aib", "Nassim Ilmane"],
      "founded": "2016",
      "keywords": ["agritech", "intelligence artificielle", "IoT", "eau", "agriculture"],
      "emoji": "🌿"
    },
    {
      "category": "Technologie",
      "title": "Think Touch Solution",
      "description": "Startup biomédicale utilisant l'IA pour la pharmacovigilance et les affaires réglementaires.",
      "details": "Think Touch Solution, fondée en 2022 par Farah Bouras, développe des solutions basées sur l’intelligence artificielle pour améliorer la gestion des données en santé et pharmacie, avec un focus particulier sur la pharmacovigilance et les processus réglementaires.",
      "founders": ["Farah Bouras"],
      "founded": "2022",
      "keywords": ["santé", "IA", "pharmacie", "pharmacovigilance", "réglementation", "biomédical"],
      "emoji": "🧬"
    },
    {
      "category": "Médical",
      "title": "M-Click Solution",
    ...
    },
    {
      "category": "Médical",
      "title": "Assista Soins",
      "description": "Plateforme d’e-santé facilitant l’accès aux soins médicaux à Constantine.",
      "details": "Fondée en 2022 par Nacereddine Haddad, Assista Soins est une application mobile de santé qui connecte les patients aux soins médicaux : consultations, soins infirmiers, prélèvements sanguins et transport sanitaire. Elle travaille avec plus de 185 partenaires pour renforcer l’offre de santé locale.",
      "founders": ["Nacereddine Haddad"],
      "founded": "2022",
      "keywords": ["e-santé", "soins à domicile", "consultations médicales", "transport sanitaire", "plateforme mobile"],
      "emoji": "🩹"
    },
    {
      "category": "Médical",
      "title": "SARL DOWAYA",
      "description": "Plateforme e-santé facilitant l’accès à des médecins qualifiés et à des pharmacies.",
      "details": "Créée en 2022, SARL DOWAYA est une startup algérienne qui aide les patients à trouver des médecins expérimentés et à localiser des pharmacies. Elle gère également les profils des professionnels de santé pour améliorer leur visibilité et optimiser la gestion de leurs informations.",
      "founders": ["Mohammed Dehini", "Dehini Bilal", "Houaria Djilali Mammar"],
      "founded": "2022",
      "keywords": ["e-santé", "médecins", "pharmacies", "gestion médicale", "accessibilité"],
      "emoji": "💉"
    },
    {
      "category": "Médical",
    ...
    },
    {
      ...
      "title": "Irigreen",
      "description": "Startup spécialisée dans les systèmes d'irrigation souterraine pour une agriculture plus productive et durable.",
      "details": "Irigreen, fondée en 2023 par Lotfi Belkhir, propose un système innovant d'irrigation nano-goutte qui permet d'économiser l'eau et de réduire le gaspillage, tout en améliorant la productivité agricole.",
      "founders": ["Lotfi Belkhir"],
      "founded": "2023",
      "keywords": ["irrigation", "souterraine", "agriculture", "efficacité", "durabilité"],
      "emoji": "🌱"
    },
    {
      "category": "Agriculture",
      "title": "Farm AI",
      "description": "Utilisation de l'intelligence artificielle pour améliorer la gestion des cultures agricoles.",
      "details": "Fondée en 2019, Farm AI utilise des outils d'analyse en temps réel permettant aux agriculteurs d'optimiser les rendements agricoles tout en réduisant les coûts et en améliorant la productivité.",
      "founders": [],
      "founded": "2019",
      "keywords": ["IA", "agriculture", "productivité", "analyse", "rendements"],
      "emoji": "🤖"
    },
    {
      "category": "Agriculture",
      "title": "Green Energy Algeria",
      "description": "Solutions d'irrigation intelligente et d'utilisation des énergies renouvelables dans le secteur agricole.",
      "details": "Green Energy Algeria, fondée en 2019, se spécialise dans l'irrigation intelligente et l'utilisation des énergies renouvelables pour optimiser l'utilisation des ressources en agriculture.",
      "founders": [],
      "founded": "2019",
      "keywords": ["énergie renouvelable", "irrigation", "agriculture durable", "gestion de l'eau", "économie d'énergie"],
      "emoji": "🌍"
    },
    {
      "category": "Agriculture",
      "title": "AgriStart",
      "description": "Plateforme numérique reliant les agriculteurs à des experts et des fournisseurs de services agricoles.",
      "details": "AgriStart, lancée en 2020, facilite l'accès des agriculteurs algériens à des conseils et des services agricoles, améliorant ainsi la gestion et l'efficacité des exploitations agricoles.",
      "founders": [],
      "founded": "2020",
      "keywords": ["plateforme", "agriculture", "services", "expertise", "gestion agricole"],
      "emoji": "🌾"
    },
    {
      "category": "Finance",
    ...
    },
    {
      "category": "Finance",
      "title": "Immotify",
      "description": "Plateforme numérique dédiée à la gestion immobilière.",
      "details": "Immotify, fondée en 2020 par Aymen Hadjoudj, facilite la location, l'achat et la vente de biens immobiliers en offrant des outils en ligne innovants.",
      "founders": ["Aymen Hadjoudj"],
      "founded": "2020",
      "keywords": ["immobilier", "gestion", "plateforme", "location", "vente"],
      "emoji": "🏠"
    },
    {
      "category": "Finance",
    ...
    },
    {
      "category": "Transport",
      "title": "Yassir",
      "description": "Super application offrant des services de transport, de livraison et de paiement en ligne.",
      "details": "Yassir, fondée en 2017 par Noureddine Tayebi, facilite la mobilité et les transactions numériques en Algérie et dans plusieurs autres pays.",
      "founders": ["Noureddine Tayebi"],
      "founded": "2017",
      "keywords": ["transport", "livraison", "paiement", "application", "mobilité"],
      "emoji": "🚗"
    },
    {
      "category": "Transport",
    ...
    {
      "category": "Énergie et Environnement",
    ...
    {
      "category": "Énergie et Environnement",
      "title": "Ahmed Boufdouche entreprise",
      "description": "Installation de pompes solaires pour le secteur agricole.",
      "details": "Ahmed Boufdouche entreprise, fondée en 2022, se spécialise dans l'installation de pompes solaires pour l'agriculture, tout en offrant des formations dans le domaine de l'énergie solaire.",
      "founders": ["Ahmed Boufdouche"],
      "founded": "2022",
      "keywords": ["énergie solaire", "pompes solaires", "agriculture", "formation", "énergies renouvelables"],
      "emoji": "☀️"
    },
    {
      "category": "Éducation",
    ...
    },
    {
      "category": "Éducation",
      "title": "iMadrassa",
      "description": "Plateforme éducative pour le soutien scolaire en ligne.",
      "details": "iMadrassa, fondée en 2015 par Patrick Baudry, propose plus de 22 000 cours et 4 000 vidéos pour soutenir les élèves algériens, en particulier ceux des régions défavorisées.",
      "founders": ["Patrick Baudry"],
      "founded": "2015",
      "keywords": ["soutien scolaire", "éducation", "en ligne", "Algérie", "cours"],
      "emoji": "🎓"
    },
    {
      "category": "Éducation",
